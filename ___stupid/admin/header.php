        ...
        <nav>
            <ul>
                ...
                <?php if(DEVELOPMENT_MODE): ?>
                    <li><a href="scan" class="<?php if(isCurrentPage("scan")) echo "active" ?>" data-placement="bottom" data-toggle="tooltip" title="Scan new contents and files">Scan</a></li><?php endif; ?>
                <?php if(DEVELOPMENT_MODE): ?>
                    <li><a href="admin-pages" class="<?php if(isCurrentPage("admin-pages")) echo "active" ?>" data-placement="bottom" data-toggle="tooltip" title="Manage pages">Pages</a></li><?php endif; ?>
                <?php if(DEVELOPMENT_MODE): ?>
                    <li><a href="clean" class="<?php if(isCurrentPage("clean")) echo "active" ?>" data-placement="bottom" data-toggle="tooltip" title="Clear old contents and files">Clean</a></li><?php endif; ?>
                <?php if(DEVELOPMENT_MODE): ?>
                    <li><a href="clear" class="<?php if(isCurrentPage("clear")) echo "active" ?>" data-placement="bottom" data-toggle="tooltip" title="Clear cache">Clear</a></li><?php endif; ?>
